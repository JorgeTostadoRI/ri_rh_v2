...
class PracticanteCard extends StatelessWidget {
  const PracticanteCard({
    super.key,
  ...
  static final practicanteTypeNames = {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    _StatusChip(status: practicante.status!),
                  ],
                ),
                Row(
                  spacing: 6,
                  ...
                  children: [
                    ...
                    Text(
                      practicanteTypeNames[practicante.type]!,
            ...
            Column(
              ...
              children: [
                  ...
                  children: [
                    Flexible(
                      child: _AttributeLabel(
                        ...
                        value: practicante.salary.toString(),
                      ),
                    ),
                    Flexible(
                      child: _AttributeLabel(
                ...
                _AttributeLabel(
                  ...
                  value: practicante.university.nombre,
                ),
              ],
            ),
            Spacer(),
