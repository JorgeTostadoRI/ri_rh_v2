...
const String permisoCategory = 'permisos';
const String faltaCategory = 'faltas';
const String horasExtraCategory = 'horas-extras';
const String vacacionesCategory = 'vacaciones';
const String retardoCategory = 'retardos';
const String incapacidadCategory = 'incapacidades';
const String requerimientoJudicialCategory = 'requerimientos-judiciales';
...
final List<IncidenciaCategory> incidenciaCategories = [
  ...
  const IncidenciaCategory(
    id: requerimientoJudicialCategory,
