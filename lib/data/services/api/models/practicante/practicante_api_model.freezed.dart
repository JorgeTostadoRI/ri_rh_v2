...
mixin _$PracticanteApiModel implements DiagnosticableTreeMixin {
 ...
 int get id;@JsonKey(name: 'estado') StatusPracticante? get status;@JsonKey(name: 'tipo') TypePracticante get type;@JsonKey(name: 'nombre_completo') String get name;@JsonKey(name: 'salario_diario', fromJson: _doubleFromJson) double get salary;@JsonKey(name: 'universidad') int get universityRef;@JsonKey(name: 'puesto') int get puestoRef; DateTime get fechaNacimiento; String get clabeInterbancaria; String get numeroContacto; String get contactoEmergencia; String get curp; String get rfc;@JsonKey(name: 'numero_seguro_social') String get nss;@JsonKey(name: 'direccion_completa') String get direccion;@JsonKey(defaultValue: 0, name: 'usuario') int get userRef;@JsonKey(defaultValue: 0, name: 'jefe') int get jefeRef; bool get hasSignature;@JsonKey(name: 'identificacion_oficial') String? get ineUrl;@JsonKey(name: 'acta_nacimiento') String? get actaNacimientoUrl;@JsonKey(name: 'estado_cuenta') String? get estadoCuentaUrl;@JsonKey(name: 'pdf_curp') String? get curpUrl;@JsonKey(name: 'pdf_rfc') String? get rfcUrl;@JsonKey(name: 'pdf_numero_seguro_social') String? get nssUrl;@JsonKey(name: 'comprobante_domicilio') String? get domicilioUrl;@JsonKey(name: 'carta_presentacion') String? get cartaPresentacionUrl;@JsonKey(name: 'curriculum_vitae') String? get cvUrl;@JsonKey(name: 'fecha_alta') DateTime? get registeredAt;@JsonKey(name: 'fecha_baja') DateTime? get terminatedAt;@JsonKey(name: 'credenciales_generadas') CredencialesGeneradas? get credencialesGeneradas;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('id', id))..add(DiagnosticsProperty('status', status))..add(DiagnosticsProperty('type', type))..add(DiagnosticsProperty('name', name))..add(DiagnosticsProperty('salary', salary))..add(DiagnosticsProperty('universityRef', universityRef))..add(DiagnosticsProperty('puestoRef', puestoRef))..add(DiagnosticsProperty('fechaNacimiento', fechaNacimiento))..add(DiagnosticsProperty('clabeInterbancaria', clabeInterbancaria))..add(DiagnosticsProperty('numeroContacto', numeroContacto))..add(DiagnosticsProperty('contactoEmergencia', contactoEmergencia))..add(DiagnosticsProperty('curp', curp))..add(DiagnosticsProperty('rfc', rfc))..add(DiagnosticsProperty('nss', nss))..add(DiagnosticsProperty('direccion', direccion))..add(DiagnosticsProperty('userRef', userRef))..add(DiagnosticsProperty('jefeRef', jefeRef))..add(DiagnosticsProperty('hasSignature', hasSignature))..add(DiagnosticsProperty('ineUrl', ineUrl))..add(DiagnosticsProperty('actaNacimientoUrl', actaNacimientoUrl))..add(DiagnosticsProperty('estadoCuentaUrl', estadoCuentaUrl))..add(DiagnosticsProperty('curpUrl', curpUrl))..add(DiagnosticsProperty('rfcUrl', rfcUrl))..add(DiagnosticsProperty('nssUrl', nssUrl))..add(DiagnosticsProperty('domicilioUrl', domicilioUrl))..add(DiagnosticsProperty('cartaPresentacionUrl', cartaPresentacionUrl))..add(DiagnosticsProperty('cvUrl', cvUrl))..add(DiagnosticsProperty('registeredAt', registeredAt))..add(DiagnosticsProperty('terminatedAt', terminatedAt))..add(DiagnosticsProperty('credencialesGeneradas', credencialesGeneradas));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,type,name,salary,universityRef,puestoRef,fechaNacimiento,clabeInterbancaria,numeroContacto,contactoEmergencia,curp,rfc,nss,direccion,userRef,jefeRef,hasSignature,ineUrl,actaNacimientoUrl,estadoCuentaUrl,curpUrl,rfcUrl,nssUrl,domicilioUrl,cartaPresentacionUrl,cvUrl,registeredAt,terminatedAt,credencialesGeneradas]);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'PracticanteApiModel(id: $id, status: $status, type: $type, name: $name, salary: $salary, universityRef: $universityRef, puestoRef: $puestoRef, fechaNacimiento: $fechaNacimiento, clabeInterbancaria: $clabeInterbancaria, numeroContacto: $numeroContacto, contactoEmergencia: $contactoEmergencia, curp: $curp, rfc: $rfc, nss: $nss, direccion: $direccion, userRef: $userRef, jefeRef: $jefeRef, hasSignature: $hasSignature, ineUrl: $ineUrl, actaNacimientoUrl: $actaNacimientoUrl, estadoCuentaUrl: $estadoCuentaUrl, curpUrl: $curpUrl, rfcUrl: $rfcUrl, nssUrl: $nssUrl, domicilioUrl: $domicilioUrl, cartaPresentacionUrl: $cartaPresentacionUrl, cvUrl: $cvUrl, registeredAt: $registeredAt, terminatedAt: $terminatedAt, credencialesGeneradas: $credencialesGeneradas)';
}
...
as bool,ineUrl: freezed == ineUrl ? _self.ineUrl : ineUrl // ignore: cast_nullable_to_non_nullable
...
as DateTime?,credencialesGeneradas: freezed == credencialesGeneradas ? _self.credencialesGeneradas : credencialesGeneradas // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(name: 'credenciales_generadas') final  CredencialesGeneradas? credencialesGeneradas;
...
@override $CredencialesGeneradasCopyWith<$Res>? get credencialesGeneradas;
