...
mixin _$PracticanteApiModel implements DiagnosticableTreeMixin {
 ...
 int get id;@JsonKey(name: 'estado') StatusPracticante? get status;@JsonKey(name: 'tipo') TypePracticante get type;@JsonKey(name: 'nombre_completo') String get name;@JsonKey(name: 'salario_diario', fromJson: _doubleFromJson) double get salary;@JsonKey(name: 'universidad') int get universityRef; int get puestoRef; DateTime get fechaNacimiento; String get clabeInterbancaria; String get numeroContacto; String get contactoEmergencia; String get curp; String get rfc;@JsonKey(name: 'numeroSeguroSocial') String get nss;@JsonKey(name: 'direccion_completa') String get direccion;@JsonKey(name: 'identificacion_oficial') String? get ineUrl;@JsonKey(name: 'acta_nacimiento') String? get actaNacimientoUrl;@JsonKey(name: 'estado_cuenta') String? get estadoCuentaUrl;@JsonKey(name: 'pdf_curp') String? get curpUrl;@JsonKey(name: 'pdf_rfc') String? get rfcUrl;@JsonKey(name: 'pdf_numero_seguro_social') String? get nssUrl;@JsonKey(name: 'comprobante_domicilio') String? get domicilioUrl;@JsonKey(name: 'carta_presentacion') String? get cartaPresentacionUrl;@JsonKey(name: 'curriculum_vitae') String? get cvUrl;@JsonKey(name: 'fechaAlta') DateTime? get registeredAt;@JsonKey(name: 'fechaBaja') DateTime? get terminatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,type,name,salary,universityRef,puestoRef,fechaNacimiento,clabeInterbancaria,numeroContacto,contactoEmergencia,curp,rfc,nss,direccion,ineUrl,actaNacimientoUrl,estadoCuentaUrl,curpUrl,rfcUrl,nssUrl,domicilioUrl,cartaPresentacionUrl,cvUrl,registeredAt,terminatedAt]);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'PracticanteApiModel(id: $id, status: $status, type: $type, name: $name, salary: $salary, universityRef: $universityRef, puestoRef: $puestoRef, fechaNacimiento: $fechaNacimiento, clabeInterbancaria: $clabeInterbancaria, numeroContacto: $numeroContacto, contactoEmergencia: $contactoEmergencia, curp: $curp, rfc: $rfc, nss: $nss, direccion: $direccion, ineUrl: $ineUrl, actaNacimientoUrl: $actaNacimientoUrl, estadoCuentaUrl: $estadoCuentaUrl, curpUrl: $curpUrl, rfcUrl: $rfcUrl, nssUrl: $nssUrl, domicilioUrl: $domicilioUrl, cartaPresentacionUrl: $cartaPresentacionUrl, cvUrl: $cvUrl, registeredAt: $registeredAt, terminatedAt: $terminatedAt)';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'estado') StatusPracticante? status,@JsonKey(name: 'tipo') TypePracticante type,@JsonKey(name: 'nombre_completo') String name,@JsonKey(name: 'salario_diario', fromJson: _doubleFromJson) double salary,@JsonKey(name: 'universidad') int universityRef, int puestoRef, DateTime fechaNacimiento, String clabeInterbancaria, String numeroContacto, String contactoEmergencia, String curp, String rfc,@JsonKey(name: 'numeroSeguroSocial') String nss,@JsonKey(name: 'direccion_completa') String direccion,@JsonKey(name: 'identificacion_oficial') String? ineUrl,@JsonKey(name: 'acta_nacimiento') String? actaNacimientoUrl,@JsonKey(name: 'estado_cuenta') String? estadoCuentaUrl,@JsonKey(name: 'pdf_curp') String? curpUrl,@JsonKey(name: 'pdf_rfc') String? rfcUrl,@JsonKey(name: 'pdf_numero_seguro_social') String? nssUrl,@JsonKey(name: 'comprobante_domicilio') String? domicilioUrl,@JsonKey(name: 'carta_presentacion') String? cartaPresentacionUrl,@JsonKey(name: 'curriculum_vitae') String? cvUrl,@JsonKey(name: 'fechaAlta') DateTime? registeredAt,@JsonKey(name: 'fechaBaja') DateTime? terminatedAt
});
...
@override@JsonKey(name: 'numeroSeguroSocial') final  String nss;
...
@override@JsonKey(name: 'fechaAlta') final  DateTime? registeredAt;
@override@JsonKey(name: 'fechaBaja') final  DateTime? terminatedAt;
