...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,type,name,salary,universityRef,puestoRef,fechaNacimiento,clabeInterbancaria,numeroContacto,contactoEmergencia,curp,rfc,nss,direccion,userRef,jefeRef,hasSignature,ineUrl,actaNacimientoUrl,estadoCuentaUrl,curpUrl,rfcUrl,nssUrl,domicilioUrl,cartaPresentacionUrl,cvUrl,registeredAt,terminatedAt]);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'PracticanteApiModel(id: $id, status: $status, type: $type, name: $name, salary: $salary, universityRef: $universityRef, puestoRef: $puestoRef, fechaNacimiento: $fechaNacimiento, clabeInterbancaria: $clabeInterbancaria, numeroContacto: $numeroContacto, contactoEmergencia: $contactoEmergencia, curp: $curp, rfc: $rfc, nss: $nss, direccion: $direccion, userRef: $userRef, jefeRef: $jefeRef, hasSignature: $hasSignature, ineUrl: $ineUrl, actaNacimientoUrl: $actaNacimientoUrl, estadoCuentaUrl: $estadoCuentaUrl, curpUrl: $curpUrl, rfcUrl: $rfcUrl, nssUrl: $nssUrl, domicilioUrl: $domicilioUrl, cartaPresentacionUrl: $cartaPresentacionUrl, cvUrl: $cvUrl, registeredAt: $registeredAt, terminatedAt: $terminatedAt)';
}
