...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,type,name,salary,universityRef,puestoRef,fechaNacimiento,clabeInterbancaria,numeroContacto,contactoEmergencia,curp,rfc,nss,direccion,userRef,ineUrl,actaNacimientoUrl,estadoCuentaUrl,curpUrl,rfcUrl,nssUrl,domicilioUrl,cartaPresentacionUrl,cvUrl,registeredAt,terminatedAt]);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'PracticanteApiModel(id: $id, status: $status, type: $type, name: $name, salary: $salary, universityRef: $universityRef, puestoRef: $puestoRef, fechaNacimiento: $fechaNacimiento, clabeInterbancaria: $clabeInterbancaria, numeroContacto: $numeroContacto, contactoEmergencia: $contactoEmergencia, curp: $curp, rfc: $rfc, nss: $nss, direccion: $direccion, userRef: $userRef, ineUrl: $ineUrl, actaNacimientoUrl: $actaNacimientoUrl, estadoCuentaUrl: $estadoCuentaUrl, curpUrl: $curpUrl, rfcUrl: $rfcUrl, nssUrl: $nssUrl, domicilioUrl: $domicilioUrl, cartaPresentacionUrl: $cartaPresentacionUrl, cvUrl: $cvUrl, registeredAt: $registeredAt, terminatedAt: $terminatedAt)';
}
...
switch (_that) {
case _PracticanteApiModel() when $default != null:
return $default(_that.id,_that.status,_that.type,_that.name,_that.salary,_that.universityRef,_that.puestoRef,_that.fechaNacimiento,_that.clabeInterbancaria,_that.numeroContacto,_that.contactoEmergencia,_that.curp,_that.rfc,_that.nss,_that.direccion,_that.userRef,_that.ineUrl,_that.actaNacimientoUrl,_that.estadoCuentaUrl,_that.curpUrl,_that.rfcUrl,_that.nssUrl,_that.domicilioUrl,_that.cartaPresentacionUrl,_that.cvUrl,_that.registeredAt,_that.terminatedAt);case _:
  return orElse();
