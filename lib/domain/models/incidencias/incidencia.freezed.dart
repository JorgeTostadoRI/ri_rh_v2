...
as IncidenciaState?,solicitor: freezed == solicitor ? _self.solicitor : solicitor // ignore: cast_nullable_to_non_nullable
as User?,approvedBy: freezed == approvedBy ? _self.approvedBy : approvedBy // ignore: cast_nullable_to_non_nullable
as User?,rhApprovedBy: freezed == rhApprovedBy ? _self.rhApprovedBy : rhApprovedBy // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$UserCopyWith<$Res>? get rhApprovedBy {
    if (_self.rhApprovedBy == null) {
    return null;
  }

  return $UserCopyWith<$Res>(_self.rhApprovedBy!, (value) {
    return _then(_self.copyWith(rhApprovedBy: value));
  });
}/// Create a copy of Incidencia
/// with the given fields replaced by the non-null parameter values.
@override
@pragma('vm:prefer-inline')
$UserCopyWith<$Res>? get rejectedBy {
    if (_self.rejectedBy == null) {
    return null;
  }
...
@override final  User? rhApprovedBy;
