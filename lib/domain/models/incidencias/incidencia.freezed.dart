...
mixin _$Incidencia implements DiagnosticableTreeMixin {
 ...
 int? get id; DateTime? get createdAt; DateTime? get updatedAt; IncidenciaState? get state; User? get revisor; User? get solicitor; String? get rejectionReason; String? get pdfUrl; DateTime get start; DateTime get end; String get reason; List<IncidenciaFile> get files; IncidenciaCategory get category;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('id', id))..add(DiagnosticsProperty('createdAt', createdAt))..add(DiagnosticsProperty('updatedAt', updatedAt))..add(DiagnosticsProperty('state', state))..add(DiagnosticsProperty('revisor', revisor))..add(DiagnosticsProperty('solicitor', solicitor))..add(DiagnosticsProperty('rejectionReason', rejectionReason))..add(DiagnosticsProperty('pdfUrl', pdfUrl))..add(DiagnosticsProperty('start', start))..add(DiagnosticsProperty('end', end))..add(DiagnosticsProperty('reason', reason))..add(DiagnosticsProperty('files', files))..add(DiagnosticsProperty('category', category));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,updatedAt,state,revisor,solicitor,rejectionReason,pdfUrl,start,end,reason,const DeepCollectionEquality().hash(files),category);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'Incidencia(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, state: $state, revisor: $revisor, solicitor: $solicitor, rejectionReason: $rejectionReason, pdfUrl: $pdfUrl, start: $start, end: $end, reason: $reason, files: $files, category: $category)';
}
...
@useResult
$Res call({
 int? id, DateTime? createdAt, DateTime? updatedAt, IncidenciaState? state, User? revisor, User? solicitor, String? rejectionReason, String? pdfUrl, DateTime start, DateTime end, String reason, List<IncidenciaFile> files, IncidenciaCategory category
});


$UserCopyWith<$Res>? get revisor;$UserCopyWith<$Res>? get solicitor;
...
as User?,solicitor: freezed == solicitor ? _self.solicitor : solicitor // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$UserCopyWith<$Res>? get revisor {
    if (_self.revisor == null) {
    return null;
  }

  return $UserCopyWith<$Res>(_self.revisor!, (value) {
...
@override
@pragma('vm:prefer-inline')
$UserCopyWith<$Res>? get solicitor {
    if (_self.solicitor == null) {
    return null;
  }

  return $UserCopyWith<$Res>(_self.solicitor!, (value) {
    return _then(_self.copyWith(solicitor: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  DateTime? createdAt,  DateTime? updatedAt,  IncidenciaState? state,  User? revisor,  User? solicitor,  String? rejectionReason,  String? pdfUrl,  DateTime start,  DateTime end,  String reason,  List<IncidenciaFile> files,  IncidenciaCategory category)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Incidencia() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.state,_that.revisor,_that.solicitor,_that.rejectionReason,_that.pdfUrl,_that.start,_that.end,_that.reason,_that.files,_that.category);case _:
  return orElse();
...
class _Incidencia with DiagnosticableTreeMixin implements Incidencia {
  const _Incidencia({this.id, this.createdAt, this.updatedAt, this.state, this.revisor, this.solicitor, this.rejectionReason, this.pdfUrl, required this.start, required this.end, required this.reason, required  List<IncidenciaFile> files, required this.category}): _files = files;
...
@override final  User? revisor;
@override final  User? solicitor;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,updatedAt,state,revisor,solicitor,rejectionReason,pdfUrl,start,end,reason,const DeepCollectionEquality().hash(_files),category);
...
@override $UserCopyWith<$Res>? get revisor;@override $UserCopyWith<$Res>? get solicitor;
