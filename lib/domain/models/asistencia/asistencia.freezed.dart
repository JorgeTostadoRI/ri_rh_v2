...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'Asistencia(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, type: $type, isLate: $isLate, photoPath: $photoPath, photoFile: $photoFile, usuario: $usuario)';
}
...
class _Asistencia with DiagnosticableTreeMixin implements Asistencia {
  const _Asistencia({this.id, this.createdAt, this.updatedAt, this.type, this.isLate, @JsonKey(name: 'photo') this.photoPath, @JsonKey(includeFromJson: false, includeToJson: false) this.photoFile, required this.usuario});
