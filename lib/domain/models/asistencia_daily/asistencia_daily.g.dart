...
_AsistenciaDaily _$AsistenciaDailyFromJson(Map<String, dynamic> json) =>
    _AsistenciaDaily(
...
Map<String, dynamic> _$AsistenciaDailyToJson(_AsistenciaDaily instance) =>
    <String, dynamic>{
      'id': instance.id,
...
const _$AsistenciaStatusEnumMap = {
  ...
  AsistenciaStatus.authorizedLate: 'authorized_late',
};
